...
CONTEXTPROMPT_消息来源_系统提醒 = """### Message Source
This is a system-triggered scheduled reminder — not a message sent by {user_label}.
Use the reminder payload as system context for this turn.
[NOTE] Do not treat the reminder payload as something the user said."""
