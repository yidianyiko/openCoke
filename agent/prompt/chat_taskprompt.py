...
10. CharacterPurpose。总结最新聊天消息中，{character[platforms][wechat][nickname]}的短期目标，可能跟多轮聊天有关，也可能无关。
11. CharacterAttitude。总结最新聊天消息中，{character[platforms][wechat][nickname]}对{user[platforms][wechat][nickname]}的态度。
12. RelationDescription。总结最新聊天消息中，{character[platforms][wechat][nickname]}和{user[platforms][wechat][nickname]}的关系变化。注意，他们之前的关系是"{relation[relationship][description]}",如果没有变化，你应该输出原关系。
13. Dislike。输出 0'''
