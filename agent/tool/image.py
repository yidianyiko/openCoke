...
from framework.tool.text2image.liblib import getstatus, text2img
from util.oss import bucket, upload_file


def generate_character_image(
    prompt, imgCount=1, mode=0, sub_mode="半身照", resizedWidth=768, resizedHeight=1024
):
...
def generate_character_image_save(
    generateUuid, save_path="agent/role/default/role_image/"
):
...
if __name__ == "__main__":
    ...
    task_id = generate_character_image(prompt, 1, 0, "全身照")
    saved = generate_character_image_save(task_id)
    print(saved)
