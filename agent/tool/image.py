...
def generate_character_image(prompt, imgCount=1, mode=0, sub_mode="半身照", resizedWidth=768, resizedHeight=1024):
...
def generate_character_image_save(generateUuid, save_path="agent/role/default/role_image/"):
