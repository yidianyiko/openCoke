...
def image2text_tool(
    ...
    try:
        ...
        if result:
            ...
            return {"ok": False, "description": "", "error": "图片识别失败"}
    except Exception as e:
        logger.error(f"image2text_tool error: {e}")
        return {"ok": False, "description": "", "error": str(e)}
...
def image_generate_tool(
    ...
    """
    try:
        from agent.tool.image import (
            generate_character_image,
            generate_character_image_save,
        )
        ...
        return {"ok": False, "images": [], "origin_urls": [], "error": str(e)}
