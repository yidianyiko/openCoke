...
_DURABLE_WRITE_VISIBLE_SUMMARIES = {
    ...
    "confirm_bookable_windows": "已发布可预约时间。",
    "request_appointment": "已提交预约请求。",
    "confirm_appointment": "已确认预约。",
    "reject_appointment": "已拒绝预约请求。",
    "cancel_appointment": "已取消预约。",
    "block_service_link": "已屏蔽服务关系。",
    "unblock_service_link": "已解除服务关系屏蔽。",
    "remove_service_link": "已移除服务关系。",
}
