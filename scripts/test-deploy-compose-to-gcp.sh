...
run_two_phase_sync_case() {
  ...
  assert_contains "$call_log" "curl -fsS http://127.0.0.1:4041/health"
  assert_contains "$call_log" "curl -fsS http://127.0.0.1:8090/bridge/healthz"
  ...
  assert_contains "$call_log" "curl -fsS https://coke.ydyk123.top/auth/login"
  assert_contains "$call_log" "curl -fsS https://coke.ydyk123.top/auth/register"
  assert_contains "$call_log" "curl -k -s -o /dev/null -w '%{http_code}' https://coke.ydyk123.top/auth/login"
  assert_contains "$call_log" "curl -k -s -o /dev/null -w '%{http_code}' https://coke.ydyk123.top/auth/register"
  assert_contains "$call_log" "curl -k -s -o /dev/null -w '%{http_code}' https://coke.ydyk123.top/login"
  assert_contains "$call_log" "curl -k -s -o /dev/null -w '%{http_code}' https://coke.ydyk123.top/coke/login"
  assert_contains "$call_log" "curl -k -s -o /dev/null -w '%{http_code}' https://coke.ydyk123.top/api/coke/auth/login"
