...
def main():
    ...
    parser.add_argument("--limit", type=int, default=20, help="返回消息数量限制（默认20条）")
    parser.add_argument("--recent", action="store_true", help="按时间倒序排列，显示最近的消息（默认是按时间倒序）")
