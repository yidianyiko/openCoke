...
Usage:
    python scripts/check_future_messages.py [--all] [--pending] [--due]
...
def main():
    ...
    headers = ["会话ID", "参与者", "计划时间", "状态", "行动", "主动次数"]
    ...
    print(f"\n  统计: 已到期 {due_count} 条, 待触发 {pending_count} 条\n")
    ...
    for i, conv in enumerate(conversations, 1):
        ...
        print(f"     状态: {get_time_status(future.get('timestamp'))}")
