...
class TestRelationPersistenceWithMock(unittest.TestCase):
    ...
    def test_replace_one_with_converted_objectid(self):
        ...
        original_relation = {
            ...
            "uid": "user_123",
            "cid": "char_456",
            "relationship": {"closeness": 50, "trustness": 50, "dislike": 0},
        }
    ...
    def test_replace_one_query_uses_uid_cid(self):
        ...
        # 构建查询条件
        query = {"uid": converted["uid"], "cid": converted["cid"]}
    ...
    def test_agent_handler_replace_one_fix(self):
        ...
        relation_update = {
            k: v for k, v in converted_context["relation"].items() if k != "_id"
        }
...
class TestRelationPersistenceIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_relation = {
            ...
            "user_info": {"realname": "", "hobbyname": "", "description": "测试用户"},
            "character_info": {
    ...
    def test_create_and_update_relation(self):
        ...
        relation = self.mongo.find_one(
            "relations", {"uid": self.test_uid, "cid": self.test_cid}
        )
        ...
        result = self.mongo.replace_one(
            "relations",
            query={"uid": converted_relation["uid"], "cid": converted_relation["cid"]},
            update=relation_update,
        )
        ...
        # 7. 重新读取验证
        updated_relation = self.mongo.find_one(
            "relations", {"uid": self.test_uid, "cid": self.test_cid}
        )
...
class TestBackgroundHandlerRelationPersistence(unittest.TestCase):
    ...
    def test_background_handler_replace_one_fix(self):
        ...
        # 验证修复逻辑
        relation_update = {k: v for k, v in converted["relation"].items() if k != "_id"}
