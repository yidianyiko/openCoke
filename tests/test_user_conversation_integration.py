...
class TestRealReminderIntegration(unittest.TestCase):
    ...
    def test_01_user_creates_reminder_short_time(self):
        ...
        print(f"  - 触发时间: {datetime.fromtimestamp(trigger_time).strftime('%H:%M:%S')}")
    ...
    def test_02_user_queries_reminders(self):
        ...
        for r in reminders:
            trigger_time = datetime.fromtimestamp(r["next_trigger_time"]).strftime('%H:%M:%S')
...
class TestRealFutureMessageIntegration(unittest.TestCase):
    ...
    def test_01_conversation_with_future_message_planning(self):
        ...
        print(f"✓ 系统规划未来消息:")
        print(f"  - 规划时间: {datetime.fromtimestamp(future['timestamp']).strftime('%Y-%m-%d %H:%M')}")
    ...
    def test_02_find_due_future_messages(self):
        ...
        print(f"✓ 系统定时检查到期的未来消息")
        print(f"  - 当前时间: {datetime.fromtimestamp(current_timestamp).strftime('%H:%M:%S')}")
    ...
    def test_03_update_future_after_proactive_message(self):
        ...
        print(f"✓ 系统更新会话状态")
        print(f"  - 清除未来消息规划")
        print(f"  - 主动消息次数: {updated['conversation_info']['future']['proactive_times']}")
