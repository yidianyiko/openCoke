...
class TestLLMChatFromJSON:
    ...
    @pytest.mark.parametrize(
        "case",
        get_cases_by_category("basic_chat"),
        ids=lambda c: c["id"]
    )
    ...
    @pytest.mark.parametrize(
        "case",
        get_cases_by_category("question"),
        ids=lambda c: c["id"]
    )
    ...
    @pytest.mark.parametrize(
        "case",
        get_cases_by_category("multi_turn"),
        ids=lambda c: c["id"]
    )
    ...
    @pytest.mark.parametrize(
        "case",
        get_cases_by_category("edge_case"),
        ids=lambda c: c["id"]
    )
