...
def run_conversation(client, conversation: list, timeout: int) -> tuple[bool, str, list]:
    """
    执行对话流程
...
class TestLLMReminderFromJSON:
    ...
    @pytest.mark.parametrize(
        "case",
        get_cases_by_category("reminder_create"),
        ids=lambda c: c["id"]
    )
    ...
    @pytest.mark.parametrize(
        "case",
        get_cases_by_category("reminder_keyword"),
        ids=lambda c: c["id"]
    )
    ...
    @pytest.mark.parametrize(
        "case",
        get_cases_by_category("reminder_query"),
        ids=lambda c: c["id"]
    )
    ...
    @pytest.mark.parametrize(
        "case",
        get_cases_by_category("reminder_cancel"),
        ids=lambda c: c["id"]
    )
    ...
    @pytest.mark.parametrize(
        "case",
        get_cases_by_category("reminder_vague"),
        ids=lambda c: c["id"]
    )
    ...
    @pytest.mark.parametrize(
        "case",
        get_cases_by_category("reminder_recurrence"),
        ids=lambda c: c["id"]
    )
    ...
    @pytest.mark.parametrize(
        "case",
        get_cases_by_category("reminder_edge"),
        ids=lambda c: c["id"]
    )
