...
class TestSmokeE2E(unittest.TestCase):
    ...
    def test_full_message_handling_flow_mock(self):
        ...
        # 添加必要的默认值
        context["conversation"]["conversation_info"].setdefault("time_str", "2024年12月8日")
        context["conversation"]["conversation_info"].setdefault("chat_history_str", "")
        context["conversation"]["conversation_info"].setdefault("input_messages_str", "用户: 你好")
        ...
        # 这是修复的关键：移除 _id 字段
        relation_update = {
            k: v for k, v in context["relation"].items()
            if k != "_id"
        }
    ...
    def test_workflow_session_state_compatibility(self):
        ...
        session_state = {
            ...
            "relation": {
                ...
                "character_info": {"longterm_purpose": "", "shortterm_purpose": "", "attitude": ""}
            },
            "news_str": "",
