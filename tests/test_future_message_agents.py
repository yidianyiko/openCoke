...
class TestFutureMessageAgentInstantiation(unittest.TestCase):
    ...
    def test_query_rewrite_agent_attributes(self):
        ...
        self.assertEqual(future_message_query_rewrite_agent.name, "FutureMessageQueryRewriteAgent")
        
        # 检查 output_schema 配置为 QueryRewriteResponse
        self.assertEqual(future_message_query_rewrite_agent.output_schema, QueryRewriteResponse)
    ...
    def test_context_retrieve_agent_attributes(self):
        ...
        self.assertEqual(future_message_context_retrieve_agent.name, "FutureMessageContextRetrieveAgent")
...
class TestFutureMessageDynamicInstructions(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.get_future_query_rewrite_instructions = get_future_query_rewrite_instructions
        self.get_future_message_chat_instructions = get_future_message_chat_instructions
        self.get_future_context_retrieve_instructions = get_future_context_retrieve_instructions
